...
const (
	...
	CacheService_IsRoot_FullMethodName  = "/cacheservice.CacheService/IsRoot"
)
...
type CacheServiceClient interface {
	...
	IsRoot(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*wrappers.BoolValue, error)
}
...
func (c *cacheServiceClient) IsRoot(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*wrappers.BoolValue, error) {
	out := new(wrappers.BoolValue)
	err := c.cc.Invoke(ctx, CacheService_IsRoot_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CacheServiceServer interface {
	...
	IsRoot(context.Context, *empty.Empty) (*wrappers.BoolValue, error)
...
func (UnimplementedCacheServiceServer) IsRoot(context.Context, *empty.Empty) (*wrappers.BoolValue, error) {
...
func _CacheService_IsRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheServiceServer).IsRoot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CacheService_IsRoot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheServiceServer).IsRoot(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CacheService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IsRoot",
			Handler:    _CacheService_IsRoot_Handler,
		},
	},
